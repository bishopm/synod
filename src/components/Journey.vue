<template>
  <div class="q-ma-md">
    <p class="header text-h5 text-center text-red q-mb-sm">The Journey App</p>
    <p>We use the Journey App in the Lower Tugela Circuit to:</p>
    <li>share the text of this Sunday's lectionary readings</li>
    <li>distribute lectionary-based small group discussion questions</li>
    <li>publicise diary dates and allow event sign-ups</li>
    <li>share last Sunday's sermon audio recording and blog post</li>
    ...
    <div class="q-mt-md text-center">
      ...
      <div class="text-center text-bold">
        <a class="text-red" href="https://journey.church.net.za" target="_blank">https://journey.church.net.za</a>
      </div>
    </div>
  </div>
</template>
